...
class ReservationController extends Controller
{
    ...
    public function getDisabledDates($id){
        ...
        if ($area) {
            ...
            $disablecDays = AreaDisabledDay::where('id_area', $id)->get();
            foreach ($disablecDays as $disablecDay) {
                $array['list'][] = $disablecDay['day'];
            }
            ...
            //Listar os dia proibidos 3 meses pra frente
            $start = time();
        ...
        if(!$validator->fails()){
            ...
            if ($area) {
                ...
                if($can){
                    ...
                    $array['error'] = 'Esse dia não é permitido';
                }
